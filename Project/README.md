...
### План работ:
#### 1. [Составление IP плана сети](#1-ip-план-фабрики)
#### 2. [Схема сети](#2-схема-сети)
#### 3. [Настройка Underlay EBGP](#3-настройка-underlay-ebgp)
#### 4. [Настройка Overlay VXLAN EVPN](#4-настройка-overlay-vxlan-evpn)
##### ⋅⋅* [Настройка оборудования ЦОД1](#настройка-цод1)
##### ⋅⋅* [Настройка оборудования ЦОД2](#настройка-цод2)
##### ⋅⋅* [Настройка Border Leaf для связности между l2 сегментами ЦОДов](#настройка-border-leaf)
#### 5. [Настройка Multihoming ethernet сегмента в ЦОД 1](#5-настройка-multihoming)
#### 6. [Настройка инкапсуляции маршрута от EBGP соседа в фабрику](#6-инкапсуляция-маршрута)
#### 7. [Траблшутинг](#7-траблшутинг)

---
<a id="1-ip-план-фабрики"></a>
## 1. IP-план фабрики
### 🏢 ЦОД-1 (DC1)
#### Loopback (VTEP)
...
<a id="3-настройка-underlay-ebgp"></a>
